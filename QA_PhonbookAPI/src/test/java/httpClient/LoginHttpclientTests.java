...
public class LoginHttpclientTests {
    ...
    public void loginDraftPositiveTest() throws IOException {
        String email = "testal@gmail.com";
        String password = "Banancik_1966!";

        Response response = Request.Post("https://ilcarro-backend.herokuapp.com/v1/user/login/usernamepassword")
                .bodyString("{\n" +
                        "  \"username\": \"" + email +"\",\n" +
                        "  \"password\": \"" + password +"\"\n" +
    ...
    public void loginPositiveTest() throws IOException {
        ...
        AuthRequestDto requestDto = AuthRequestDto.builder()
                .username("testal@gmail.com")
                .password("Banancik_1966!")
                .build();
